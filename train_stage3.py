...
if __name__ == "__main__":
    ...
    model_dir = os.path.join(OUTPUT_PATH, args.dataset, 'stage_2', args.stage_2_trained,
    ...
    if args.network_checkpoint is not None:
        net_checkpoint_path = os.path.join(OUTPUT_PATH, args.dataset, 'stage_3', args.network_checkpoint,
