...
from utils_2 import GreyToColor, evaluate, PearsonCorrelation, \
    StructuralSimilarity, objective_assessment, parse_args, NLLNormal, FmriDataloader
...
if __name__ == "__main__":
    ...
    SAVE_SUB_PATH = os.path.join(SAVE_PATH, 'stage_3_vaegan_{}.pth'.format(timestep))
    ...
    if args.network_checkpoint is not None:
        net_checkpoint_path = os.path.join(OUTPUT_PATH, args.dataset, SUBJECT_PATH, 'stage_3', args.network_checkpoint,
