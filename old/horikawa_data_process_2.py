...
class kamitani_data_handler():
    ...
    def __init__(self, matlab_file ,test_img_csv = 'D:/Honours/Object Decoding Dataset/mat/image_test_id.csv',
                 train_img_csv = 'D:/Honours/Object Decoding Dataset/mat/image_training_id.csv',voxel_spacing =3,log = 0 ):
...
root_path = 'D:/Honours/Object Decoding Dataset/mat/'
horikawa_path = os.path.join(root_path, 'Subject4.mat')
handler = kamitani_data_handler(matlab_file = horikawa_path)
