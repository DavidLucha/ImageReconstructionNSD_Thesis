...
#SBATCH -N 1
#SBATCH --job-name=Study2_AllSubj_4000_5t8
#SBATCH -n 2
#SBATCH -c 25
#SBATCH --mem=50000
#SBATCH -o Study2_AllSubj_4000_5t8_output.txt
#SBATCH -e Study2_AllSubj_4000_5t8_error.txt
...
do
  ...
  do
    ...
    MESSAGE="Study2_Subj${SUBJ}_4000_5t8"
    # Study 1
    # Run stage 2
