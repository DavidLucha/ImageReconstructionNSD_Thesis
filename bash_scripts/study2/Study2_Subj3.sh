...
# DO missed subj 2 evals from before
srun -N 1 -p gpu --gres=gpu:1 --mpi=pmi2 python /clusterdata/uqdlucha/scripts/deepReconPyTorch/net_evaluation_tabular.py --data_root '/scratch/qbi/uqdlucha/datasets/' --network_root '/scratch/qbi/uqdlucha/final_networks/' --batch_size ${BATCH_SIZE} --st3_net 'Study2_SUBJ02_3mm_VC_max_Stage3_20220910-164252_final' --st3_load_epoch final --latent_dims 1024 --lin_size 2048 --lin_layers 2 --save True --vox_res ${VOX_RES} --ROI ${ROI} --set_size ${SET_SIZE} --subject 2 --num_workers 2 --dataset NSD --seed 277603 --message "hello"