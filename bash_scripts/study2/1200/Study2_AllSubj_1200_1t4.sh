...
#SBATCH -N 1
#SBATCH --job-name=Study2_AllSubj_1200_1t4
#SBATCH -n 2
#SBATCH -c 25
#SBATCH --mem=50000
#SBATCH -o Study2_AllSubj_1200_1t4_output.txt
#SBATCH -e Study2_AllSubj_1200_1t4_error.txt
...
do
  ...
  do
    ...
    MESSAGE="Study2_Subj${SUBJ}_1200_1t4"
    # Study 1
    # Run stage 2
