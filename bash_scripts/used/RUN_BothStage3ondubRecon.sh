...
#SBATCH -N 1
#SBATCH --job-name=Stage3_Both_dubrecon
#SBATCH -n 2
#SBATCH -c 25
#SBATCH --mem=20000
#SBATCH -o Stage3_Both_dubrecon_output.txt
#SBATCH -e Stage3_Both_dubrecon_error.txt
