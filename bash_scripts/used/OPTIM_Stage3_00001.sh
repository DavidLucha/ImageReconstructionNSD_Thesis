...
#SBATCH -N 1
#SBATCH --job-name=optim_stage3_00001
#SBATCH -n 2
#SBATCH -c 25
#SBATCH --mem=50000
#SBATCH -o optim_stage3_00001_output.txt
#SBATCH -e optim_stage3_00001_error.txt
...
srun -N 1 -p gpu --gres=gpu:1 --mpi=pmi2 python /clusterdata/uqdlucha/scripts/deepReconPyTorch/train_stage3_iter.py --run_name optim_stage_3_00001_subj0${SUBJ}_${RUN_NAME} --vox_res ${VOX_RES} --set_size ${SET_SIZE} --subject ${SUBJ} --stage_2_trained optim_stage_2_0003_shuffle_20220805-122457 --load_epoch final --lr_dec 0.00001 --lr_disc 0.00001 --valid_shuffle True --backprop_method trad --num_workers 2 --epochs 150 --iters 15000 --dataset NSD --seed 277603 --equilibrium_game y --message "Stage 3, subject ${SUBJ}, at ${VOX_RES} voxel resolution, with set size of: ${SET_SIZE}. Dec .00001, Dis .00001. Equi on."
