...
#SBATCH -N 1
#SBATCH --job-name=4T12C
#SBATCH -n 4
#SBATCH -c 12
#SBATCH --mem=50000
#SBATCH -o 4T12C_output.txt
#SBATCH -e 4T12C_error.txt
...
srun -N 1 -p gpu --gres=gpu:1 --mpi=pmi2 python /clusterdata/uqdlucha/scripts/deepReconPyTorch/pretrain.py --run_name 4T12C_$RUN_NAME --lr 0.0001 --gamma 1.0 --equilibrium_game y --backprop_method clip --num_workers 4 --epochs 100 --dataset both --loss_method Maria --optim_method RMS --seed 277603 --message "4 tasks, 12 CPUs each."
