...
#SBATCH -N 1
#SBATCH --job-name=FnormalizeTest
#SBATCH -n 2
#SBATCH -c 25
#SBATCH --mem=20000
#SBATCH -o FnormalizeTest_output.txt
#SBATCH -e FnormalizeTest_error.txt
