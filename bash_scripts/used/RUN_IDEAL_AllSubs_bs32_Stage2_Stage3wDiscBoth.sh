...
#SBATCH -N 1
#SBATCH --job-name=RUN_bs32_1.8max_AllSubs_st2n3wDiscBoth
#SBATCH -n 2
#SBATCH -c 25
#SBATCH --mem=20000
#SBATCH -o RUN_bs32_1.8max_AllSubs_st2n3wDiscBoth_output.txt
#SBATCH -e RUN_bs32_1.8max_AllSubs_st2n3wDiscBoth_error.txt
