...
#SBATCH -N 1
#SBATCH --job-name=FINAL_TEST_bs16
#SBATCH -n 2
#SBATCH -c 25
#SBATCH --mem=20000
#SBATCH -o FINAL_TEST_bs16_output.txt
#SBATCH -e FINAL_TEST_bs16_error.txt
...
STAGE_1_EPOCH="249"
RUN_NAME="FINAL_TEST_bs16_SUBJ0${SUBJ}_${VOX_RES}_${ROI}_${SET_SIZE}"
MESSAGE="This is the default. just at 16bs"
# ------ CHANGE THESE ------- #
