...
#SBATCH -N 1
#SBATCH --job-name=FINAL_TEST_highMomentum
#SBATCH -n 2
#SBATCH -c 25
#SBATCH --mem=20000
#SBATCH -o FINAL_TEST_highMomentum_output.txt
#SBATCH -e FINAL_TEST_highMomentum_error.txt
...
STAGE_1_EPOCH="249"
RUN_NAME="FINAL_TEST_highMomentum_SUBJ0${SUBJ}_${VOX_RES}_${ROI}_${SET_SIZE}"
MESSAGE="This is the default. higher momentum .98 instead of .9 and introduced weight decay in stage 3"
# ------ CHANGE THESE ------- #
