...
#SBATCH -N 1
#SBATCH --job-name=Ren_v2_loss_1_test
#SBATCH -n 1
#SBATCH -c 1
#SBATCH --mem=10000
#SBATCH -o Ren_v2_loss_1_test_output.txt
#SBATCH -e Ren_v2_loss_1_test_error.txt
