...
srun -N 1 -p gpu --gres=gpu:1 --mpi=pmi2 python /clusterdata/uqdlucha/scripts/deepReconPyTorch/train_stage2_WAE_iter.py --run_name WAE_ST2_512_Test_$RUN_NAME --load_from pretrain --pretrained_net WAE_512_Test_20220806-115327 --load_epoch 160 --lr_enc 0.0001 --lr_disc 0.00005 --valid_shuffle True --latent_dims 512 --vox_res 1.8mm --set_size max --subject 1 --num_workers 2 --epochs 200 --iters 60000 --dataset NSD --seed 277603 --message "WAE test but at 512, with .0001 and 00005 on enc and disc respectively."
