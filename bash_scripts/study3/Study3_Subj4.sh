...
#SBATCH -N 1
#SBATCH --job-name=Study3_Subj4
#SBATCH -n 2
#SBATCH -c 25
#SBATCH --mem=20000
#SBATCH -o Study3_Subj4_output.txt
#SBATCH -e Study3_Subj4_error.txt
