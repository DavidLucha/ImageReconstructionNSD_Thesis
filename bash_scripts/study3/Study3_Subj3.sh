...
#SBATCH -N 1
#SBATCH --job-name=Study3_Subj3
#SBATCH -n 2
#SBATCH -c 25
#SBATCH --mem=20000
#SBATCH -o Study3_Subj3_output.txt
#SBATCH -e Study3_Subj3_error.txt
...
STAGE_1_EPOCH="99"
MESSAGE="Study3_Subj3"
# ------ CHANGE THESE ------- #

for ROI in V1_to_V3 V1_to_V3_n_HVC V1_to_V3_n_rand V1 V2 V3 V4 HVC
do
