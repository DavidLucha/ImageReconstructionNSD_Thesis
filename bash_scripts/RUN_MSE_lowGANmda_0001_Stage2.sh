...
#SBATCH -N 1
#SBATCH --job-name=MSEloss_lowGANbda_0001
#SBATCH -n 2
#SBATCH -c 25
#SBATCH --mem=20000
#SBATCH -o MSEloss_lowGANbda_0001_output.txt
#SBATCH -e MSEloss_lowGANbda_0001_error.txt
...
# SUBJ=1
# ------ CHANGE THESE ------- #
RUN_NAME="MSEloss_lowGANbda_0001"
VOX_RES="1.8mm"
BATCH_SIZE=64
SET_SIZE="max"
ROI="VC"
