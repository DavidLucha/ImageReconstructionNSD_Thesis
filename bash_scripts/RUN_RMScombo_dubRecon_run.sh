...
#SBATCH -N 1
#SBATCH --job-name=RMSCombo_dubrecon
#SBATCH -n 2
#SBATCH -c 25
#SBATCH --mem=20000
#SBATCH -o RMSCombo_dubrecon_output.txt
#SBATCH -e RMSCombo_dubrecon_error.txt
