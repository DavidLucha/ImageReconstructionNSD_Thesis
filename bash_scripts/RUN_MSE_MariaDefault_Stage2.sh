...
#SBATCH -N 1
#SBATCH --job-name=MSEloss_MSE_Maria_Default
#SBATCH -n 2
#SBATCH -c 25
#SBATCH --mem=20000
#SBATCH -o MSEloss_MSE_Maria_Default_output.txt
#SBATCH -e MSEloss_MSE_Maria_Default_error.txt
...
# SUBJ=1
# ------ CHANGE THESE ------- #
RUN_NAME="MSEloss_MSE_Maria_Default"
VOX_RES="1.8mm"
BATCH_SIZE=64
SET_SIZE="max"
ROI="VC"
