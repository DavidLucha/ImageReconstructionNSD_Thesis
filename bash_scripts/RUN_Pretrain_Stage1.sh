...
#SBATCH -N 1
#SBATCH --job-name=RUN2_1_pretrain_st1
#SBATCH -n 1
#SBATCH -c 1
#SBATCH --mem=10000
#SBATCH -o RUN2_1_pretrain_st1_output.txt
#SBATCH -e RUN2_1_pretrain_st1_error.txt
...
srun -N 1 -p gpu --gres=gpu:1 --mpi=pmi2 python /clusterdata/uqdlucha/scripts/deepReconPyTorch/train_stage1.py --run_name RUN2_1_stage1_$RUN_NAME --pretrained_net RUN2_1_pretrain_$RUN_NAME --load_epoch 99 --lr 0.0001 --gamma 1.0 --equilibrium_game y --backprop_method clip --num_workers 2 --epochs 200 --dataset NSD --loss_method Maria --optim_method RMS --seed 277603 --message "Proper run, using pretrain on 30k into stage 1 with only NSD. Stage 1."
