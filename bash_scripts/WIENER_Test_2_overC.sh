...
#SBATCH -N 1
#SBATCH --job-name=2T80C
#SBATCH -n 2
#SBATCH -c 80
#SBATCH --mem=50000
#SBATCH -o 2T80C_output.txt
#SBATCH -e 2T80C_error.txt
...
srun -N 1 -p gpu --gres=gpu:1 --mpi=pmi2 python /clusterdata/uqdlucha/scripts/deepReconPyTorch/pretrain.py --run_name 2T80C_$RUN_NAME --lr 0.0001 --gamma 1.0 --equilibrium_game y --backprop_method clip --num_workers 2 --epochs 100 --dataset both --loss_method Maria --optim_method RMS --seed 277603 --message "2 tasks, 25 CPUs each."
