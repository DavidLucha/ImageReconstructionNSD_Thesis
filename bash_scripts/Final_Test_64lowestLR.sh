...
#SBATCH -N 1
#SBATCH --job-name=FINAL_TEST_bs64lowestLR
#SBATCH -n 2
#SBATCH -c 25
#SBATCH --mem=20000
#SBATCH -o FINAL_TEST_bs64lowestLR_output.txt
#SBATCH -e FINAL_TEST_bs64lowestLR_error.txt
...
STAGE_1_EPOCH="249"
RUN_NAME="FINAL_TEST_bs64lowestLR_SUBJ0${SUBJ}_${VOX_RES}_${ROI}_${SET_SIZE}"
MESSAGE="This is the default. but with 64bs and loweest LR .00003 for each"
# ------ CHANGE THESE ------- #
