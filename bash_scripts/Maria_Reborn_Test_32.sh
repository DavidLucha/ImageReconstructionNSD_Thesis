...
#SBATCH -N 1
#SBATCH --job-name=Maria_Reborn_32
#SBATCH -n 2
#SBATCH -c 25
#SBATCH --mem=20000
#SBATCH -o Maria_Reborn_32_output.txt
#SBATCH -e Maria_Reborn_32_error.txt
...
STAGE_1_EPOCH="249"
RUN_NAME="Maria_Reborn_32_SUBJ0${SUBJ}_${VOX_RES}_${ROI}_${SET_SIZE}"
