...
#SBATCH -N 1
#SBATCH --job-name=WAE_David_1_Test
#SBATCH -n 2
#SBATCH -c 25
#SBATCH --mem=20000
#SBATCH -o WAE_David_1_Test_output.txt
#SBATCH -e WAE_David_1_Test_error.txt
