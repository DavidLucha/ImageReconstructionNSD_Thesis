...
#SBATCH -N 1
#SBATCH --job-name=Stage3_Maria_dubrecon
#SBATCH -n 2
#SBATCH -c 25
#SBATCH --mem=20000
#SBATCH -o Stage3_Maria_dubrecon_output.txt
#SBATCH -e Stage3_Maria_dubrecon_error.txt
...
# SUBJ=1
# ------ CHANGE THESE ------- #
RUN_NAME="Stage3_Maria_dubrecon"
VOX_RES="1.8mm"
BATCH_SIZE=64
SET_SIZE="max"
ROI="VC"
