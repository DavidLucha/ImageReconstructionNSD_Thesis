...
MESSAGE="Trying Maria again but with the no momentum in the cogenc, and self init cogenc at bs16 and default enc lr."
# ------ CHANGE THESE ------- #
