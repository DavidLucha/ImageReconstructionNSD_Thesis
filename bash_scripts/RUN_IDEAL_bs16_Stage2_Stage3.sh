...
#SBATCH -N 1
#SBATCH --job-name=RUN_bs16_1.8max_subj01_st2n3
#SBATCH -n 2
#SBATCH -c 25
#SBATCH --mem=20000
#SBATCH -o RUN_bs16_1.8max_subj01_st2n3_output.txt
#SBATCH -e RUN_bs16_1.8max_subj01_st2n3_error.txt
